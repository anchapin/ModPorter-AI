...
```
  ...
  <verify>
    <automated>
      ...
      cd /home/alex/Projects/portkit/ai-engine && python -m pytest tests/test_search_integration.py -v -x

      # Verify fixtures are loadable
      cd /home/alex/Projects/portkit/ai-engine && python -c "
      ...
      # Check test coverage
      cd /home/alex/Projects/portkit/ai-engine && python -m pytest tests/test_search_integration.py --cov=search --cov-report=term-missing --no-header
    </automated>
  </verify>
  <done>
...
- Results can be used to identify bottlenecks and optimization opportunities
  ...
  <verify>
    <automated>
      ...
      cd /home/alex/Projects/portkit/ai-engine && python benchmarking/search_benchmark.py

      # Verify benchmark completes without errors
      cd /home/alex/Projects/portkit/ai-engine && timeout 300 python benchmarking/search_benchmark.py 2>&1 | grep -E "(PASS|FAIL|Median|95th)"

      # Check if benchmark script is executable
      test -x /home/alex/Projects/portkit/ai-engine/benchmarking/search_benchmark.py && echo "Executable" || echo "Not executable (but should run with python)"
    </automated>
  </verify>
  <done>
