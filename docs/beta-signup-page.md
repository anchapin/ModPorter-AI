# Beta Signup Page Content

**Page URL:** portkit.ai/beta
**Form Tool:** Tally (or similar)
...
- First conversions expected: Week 1
...
- Complex custom rendering: Requires manual work
- Network packet handlers: Not supported
- Some mod dependencies: May not transfer
...
- Required: Yes
- Placeholder: https://...
- Helper: Share at least one mod so we can understand your work

**Field 5:** What mod(s) would you most want to convert?
- Type: Long text
- Required: Yes
- Placeholder: "My inventory mod 'X' has 50K downloads..."
- Helper: The more specific, the better we can test for you
...
- Helper: This helps us understand your use case
...
- Helper: Optional but helps us prioritize features
...
- Type: Checkbox
- Required: Yes
- Label: "I accept the [Beta Terms](link) and [Privacy Policy](link)"
...
**Q: Will my mod be publicly shown?**
A: Only if you provide written consent for case studies or testimonials. Otherwise, your conversions are private.

---

## Footer

**Questions?** Contact us at beta@portkit.cloud or join Discord.

**Links:**
- Website: portkit.ai
- Documentation: docs.portkit.ai
- Privacy Policy: portkit.ai/privacy
- Terms of Service: portkit.ai/terms
