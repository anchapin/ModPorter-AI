...
class ProgressHandler:
    ...
    async def broadcast_progress(
        ...
        try:
            ...
            logger.error(f"Failed to broadcast progress for {conversion_id}: {str(e)}", exc_info=True)
    ...
    async def broadcast_conversion_complete(conversion_id: str, download_url: str):
        ...
        try:
            ...
            logger.error(f"Failed to broadcast conversion complete for {conversion_id}: {str(e)}", exc_info=True)
    ...
    async def broadcast_conversion_failed(conversion_id: str, error_message: str):
        ...
        try:
            ...
            logger.error(f"Failed to broadcast conversion failed for {conversion_id}: {str(e)}", exc_info=True)
