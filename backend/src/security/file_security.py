...
class SecurityConfig:
    ...
    allowed_extensions: List[str] = field(
        default_factory=lambda: [".jar", ".zip", ".mcaddon", ".mcpack"]
    )
...
class FileSecurityScanner:
    ...
    def scan_file(
        self, file_path: Path, scan_content: bool = True, max_depth: int = 0
    ) -> SecurityScanResult:
        """
    ...
    def scan_upload(
        self, file_obj: BinaryIO, filename: str, scan_content: bool = True
    ) -> SecurityScanResult:
        """
    ...
    def validate_extraction_path(self, target_dir: Path, member_path: str) -> Path:
        """
