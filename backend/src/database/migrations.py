...
class MigrationManager:
        ...
        try:
            ...
            async with conn.transaction():
                ...
                await conn.execute(
                    ...
                    """,
                    migration['version'], checksum, datetime.utcnow()
                )
    ...
    async def rollback_to_version(self, target_version: str) -> int:
        ...
        try:
            applied = await self.get_applied_migrations(conn)
            applied_versions = sorted([v for v in applied if v > target_version], reverse=True)
    ...
    async def check_health(self) -> Dict:
        ...
        try:
            ...
            async with self.pool.acquire() as conn:
                ...
                health_status['checks']['connectivity'] = 'pass' if result == 1 else 'fail'
                ...
                health_status['checks']['active_connections'] = db_stats['active_connections']
