...
REAL_DB_URL = os.getenv("TEST_DATABASE_URL", "postgresql://postgres:password@localhost:5433/modporter_test")
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers",
        "integration: integration tests that may use real or mocked services"
    )
