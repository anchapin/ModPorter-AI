...
@patch("db.crud.get_asset", new_callable=AsyncMock)
@patch("services.asset_conversion_service.asset_conversion_service.convert_asset", new_callable=AsyncMock)
...
@patch("services.asset_conversion_service.asset_conversion_service.convert_assets_for_conversion", new_callable=AsyncMock)
