...
class TestModrinthService:
    ...
    async def test_search_mods_success(self):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            mock_instance.get.return_value = MagicMock(
                json=lambda: mock_response, raise_for_status=Mock()
            )
    ...
    async def test_get_file_download_url_success(self):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            mock_instance.get = AsyncMock()
            mock_instance.get.return_value = MagicMock(
                json=lambda: mock_version_response, raise_for_status=Mock()
            )
            mock_instance.__aenter__ = AsyncMock(return_value=mock_instance)
            mock_instance.__aexit__ = AsyncMock(return_value=None)
            mock_client.return_value = mock_instance
...
class TestModrinthURLParsing:
    ...
    def test_parse_mod_url(self):
        ...
        result = service.parse_modrinth_url("https://modrinth.com/mod/test-mod")
    ...
    def test_parse_plugin_url(self):
        ...
        result = service.parse_modrinth_url("https://modrinth.com/plugin/test-plugin")
    ...
    def test_parse_pack_url(self):
        ...
        result = service.parse_modrinth_url("https://modrinth.com/pack/test-pack")
    ...
    def test_parse_invalid_url(self):
        ...
        result = service.parse_modrinth_url("https://example.com/something/else")
...
class TestModrinthServiceEdgeCases:
    ...
    async def test_get_file_download_url_no_files(self):
        ...
        mock_version_response = {"id": "version1", "files": []}
