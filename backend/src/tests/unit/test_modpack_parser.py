...
def test_parse_manifest_data_invalid_type(parser):
    data = {"manifestType": "invalidType", "manifestVersion": 1}
...
def test_parse_from_manifest(parser):
    data = {"manifestType": "minecraftModpack", "manifestVersion": 1, "name": "Test Pack"}
...
def test_curseforge_manifest_properties():
    ...
    manifest = CurseForgeManifest(
        manifest_type="test", manifest_version=1, name="Test", version="1", author="A", files=files
    )
