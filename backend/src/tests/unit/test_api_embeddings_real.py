...
class TestEmbeddingsAPIReal:
    ...
    async def test_index_document_success(self, mock_crud, mock_get_db, client):
        ...
        with patch.dict("sys.modules", {"utils.embedding_generator": MagicMock(LocalEmbeddingGenerator=mock_gen_class)}):
            ...
            with patch("api.embeddings._get_ai_engine_indexing") as mock_get_indexing:
                ...
                mock_crud.create_document_with_chunks = AsyncMock(return_value=(mock_doc, [MagicMock()]))
