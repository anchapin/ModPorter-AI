...
class TestPatternMatching:
    ...
    def test_pattern_matching_returns_settings(self, engine, sample_historical_data):
        ...
        result = engine._apply_pattern_matching(
...
class TestGetDefaults:
    ...
    @pytest.mark.asyncio
    async def test_get_defaults_with_historical_data(self, engine, simple_features, sample_historical_data):
    ...
    async def test_get_defaults_with_user_preferences(self, engine, simple_features):
        ...
        with patch.object(engine, '_get_user_preferences', return_value={
            "detail_level": "minimal",
            "timeout_seconds": 100,
        }):
            result = await engine.get_defaults(
