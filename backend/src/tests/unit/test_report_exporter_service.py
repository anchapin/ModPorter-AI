...
from schemas.report_types import (
    InteractiveReport, ReportMetadata, SummaryReport, 
    FeatureAnalysis, AssumptionsReport, DeveloperLog
)
...
def mock_report():
    ...
    report.to_dict = MagicMock(return_value={
        ...
        "feature_analysis": {"compatibility_mapping_summary": "Good", "impact_assessment_summary": "Low", "features": []},
