...
class TestExportRequest:
    ...
    def test_export_request_with_file_types(self):
        ...
        request = ExportRequest(conversion_id="conv-123", file_types=["blocks", "items", "recipes"])
    ...
    def test_export_request_with_options(self):
        ...
        request = ExportRequest(conversion_id="conv-123", include_templates=False)
...
class TestExportFormatValidation:
    ...
    def test_valid_mcaddon_format(self):
        ...
        request = ExportRequest(conversion_id="conv-123", export_format="mcaddon")
        assert request.export_format == "mcaddon"
    ...
    def test_valid_zip_format(self):
        ...
        request = ExportRequest(conversion_id="conv-123", export_format="zip")
    ...
    def test_valid_json_format(self):
        ...
        request = ExportRequest(conversion_id="conv-123", export_format="json")
