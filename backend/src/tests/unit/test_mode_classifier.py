...
def simple_features():
    ...
    return ModFeatures(
        total_classes=3, total_dependencies=1, has_items=True, has_blocks=True, complex_features=[]
    )
...
class TestFeatureExtractionAgent:
    ...
    def test_extract_from_jar_minimal_content_returns_features(
        self, feature_agent, minimal_jar_content
    ):
    ...
    def test_extract_from_jar_simple_mod_detects_items_and_blocks(
        self, feature_agent, simple_mod_jar
    ):
    ...
    def test_extract_from_jar_complex_mod_detects_complex_features(
        self, feature_agent, complex_mod_jar
    ):
    ...
    def test_extract_from_jar_empty_jar_returns_zero_features(
        self, feature_agent, empty_jar_content
    ):
...
class TestClassifierAgent:
    ...
    def test_classify_blocking_features_forces_expert_mode(
        self, classifier_agent, blocking_features_mod_features
    ):
...
class TestModeClassifierEdgeCases:
    ...
    def test_classify_features_on_mode_boundaries(self, classifier_agent):
        ...
        boundary_features = ModFeatures(
            total_classes=5, total_dependencies=2, has_items=True, complex_features=[]
        )
    ...
    def test_convertible_percentage_reduces_for_blocking_features(self, classifier_agent):
        ...
        features_no_blocking = ModFeatures(
            total_classes=30, total_dependencies=5, has_items=True, complex_features=[]
        )
        ...
        assert (
            result_with_blocking.convertible_percentage < result_no_blocking.convertible_percentage
        )
