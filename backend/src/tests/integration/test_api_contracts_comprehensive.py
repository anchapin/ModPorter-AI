...
class TestRequestValidation:
    ...
    def test_valid_conversion_request(self):
        ...
        request = {"mod_file": "test.jar", "options": {"assumptions": "conservative"}}
    ...
    def test_extra_fields_ignored(self):
        ...
        request = {"mod_file": "test.jar", "extra_field": "should be ignored"}
...
class TestResponseValidation:
    ...
    def test_valid_error_response(self):
        ...
        response = {"success": False, "error": "Invalid JAR format"}
    ...
    def test_response_processing_time_type(self):
        ...
        response = {"success": True, "processing_time_ms": 1234}
...
class TestBatchContractValidation:
    ...
    def test_valid_batch_request(self):
        ...
        request = {"files": ["mod1.jar", "mod2.jar", "mod3.jar"], "options": {}, "parallel": True}
...
class TestAPIVersioning:
    ...
    def test_v1_api_format(self):
        ...
        v1_response = {"success": True, "output_file": "/tmp/test.mcaddon"}
    ...
    def test_backward_compatibility(self):
        ...
        old_response = {"success": True, "output_file": "/tmp/test.mcaddon"}
...
class TestErrorResponseContract:
    ...
    def test_error_response_structure(self):
        ...
        error_response = {
            ...
            "details": {"reason": "Missing manifest file", "location": "META-INF/MANIFEST.MF"},
        }
...
class TestPaginationContract:
    ...
    def test_list_response_pagination(self):
        ...
        response = {
            "items": [{"id": "1", "name": "conversion1"}, {"id": "2", "name": "conversion2"}],
            "total": 10,
            "page": 1,
            "page_size": 2,
            "total_pages": 5,
...
class TestWebSocketContract:
    ...
    def test_completion_message_contract(self):
        ...
        completion_message = {
            "type": "completed",
            "conversion_id": "conv_123",
            "result": {"success": True, "output_file": "/tmp/addon.mcaddon"},
            "timestamp": "2026-03-29T12:00:00Z",
        }
...
class TestDataTypeConsistency:
    ...
    def test_boolean_field_types(self):
        ...
        response = {"success": True, "validated": False}
