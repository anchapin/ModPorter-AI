...
class OptimizedGraphDatabaseManager:
    ...
    def create_node_batch(self, nodes: List[Dict[str, Any]]) -> List[Optional[str]]:
        ...
        for node in nodes:
            ...
            if 'properties' in prepared_node and isinstance(prepared_node['properties'], dict):
    ...
    def create_relationship_batch(self, relationships: List[Dict[str, Any]]) -> List[Optional[str]]:
        """
        ...
        for rel in relationships:
            ...
            if 'properties' in prepared_rel and isinstance(prepared_rel['properties'], dict):
    ...
    def get_node_neighbors(self, node_id: str, depth: int = 1, max_nodes: int = 100) -> Dict[str, Any]:
        """
    ...
    def update_node_validation(self, node_id: str, expert_validated: bool, 
        ...
        try:
            with self.get_session() as session:
                ...
                with self._cache_lock:
                    keys_to_remove = [k for k in self._query_cache.keys() if node_id in k]
