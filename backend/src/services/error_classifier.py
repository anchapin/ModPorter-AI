...
class ErrorClassifier:
    ...
    def _check_direct_type(self, error: Exception) -> Optional[ErrorClassification]:
        ...
        try:
            ...
            # Map retry error types to our error types
            type_mapping = {
            ...
            # Handle RetryableError/NonRetryableError base classes
        ...
        try:
            ...
            if isinstance(error, ModPorterException):
                # Map ModPorterException error_type field
