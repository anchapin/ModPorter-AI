    ...
    def _is_entry_valid(self, entry: CacheEntry) -> bool:
        ...
        try:
            ...
            if entry.ttl_seconds:
                # Use naive datetime for comparison with naive datetime
                now = datetime.now()
                # Both entry.created_at and now should be naive datetimes
                # If entry.created_at has timezone info, convert it to naive
