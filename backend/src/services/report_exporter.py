"""
Report Export Service for Portkit
...
class ReportExporter:
    ...
    def create_shareable_link(self, report_id: str, base_url: str = "") -> str:
        ...
        if not base_url:
            base_url = "https://portkit.cloud"  # Default base URL
...
<body>
    <div class="header">
        <h1 class="title">Portkit Conversion Report</h1>
    ...
    <div class="section">
        <p><em>Report generated by Portkit v{report[metadata][version]} on {generation_date}</em></p>
    </div>
</body>
</html>
        """
