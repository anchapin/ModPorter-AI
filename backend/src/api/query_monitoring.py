...
async def get_n_plus_one_candidates() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to fetch N+1 candidates: {str(e)}")
...
async def get_slowest_queries() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to fetch slowest queries: {str(e)}")
...
async def reset_monitor() -> Dict[str, str]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to reset monitor: {str(e)}")
...
async def enable_monitor() -> Dict[str, str]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to enable monitor: {str(e)}")
...
async def disable_monitor() -> Dict[str, str]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to disable monitor: {str(e)}")
