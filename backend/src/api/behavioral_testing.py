...
class ExpectedBehavior(BaseModel):
    ...
    type: str = Field(..., description="Behavior type: state_change, event_sequence, action_mapping")
    ...
    bedrock_equivalent_outcome: Optional[Dict[str, Any]] = Field(None, description="Bedrock equivalent")
...
class BehavioralTestRequest(BaseModel):
    ...
    expected_behaviors: Optional[List[ExpectedBehavior]] = Field(None, description="Expected behaviors")
...
async def create_behavioral_test(
    ...
    try:
        ...
        behaviors = [behavior.dict() for behavior in test_request.expected_behaviors] if test_request.expected_behaviors else None
        ...
        logger.info(f"Created behavioral test {test_id} for conversion {test_request.conversion_id}")
