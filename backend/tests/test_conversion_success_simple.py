...
class TestMockIntegration:
    ...
    def test_predict_success_with_mock_session(self, service, mock_session):
        ...
        with patch.object(service, 'predict_success', new_callable=AsyncMock) as mock_predict:
            ...
            # Test async call
            import asyncio
            result = asyncio.run(service.predict_success(mock_session, "test-pattern-id"))
