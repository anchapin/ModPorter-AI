...
class TestProgressiveLoadingStrategies:
    ...
    async def test_get_loading_strategies(self):
        ...
        expected_strategies = ["viewport_based", "distance_based", "importance_based", "hybrid"]
...
class TestProgressiveLoadingPerformance:
    ...
    async def test_estimate_load_time_success(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            ...
            mock_service.estimate_time.assert_called_once_with(**estimation_request, db=mock_db)
    ...
    async def test_optimize_loading_settings_success(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            ...
            mock_service.optimize_settings.assert_called_once_with(**optimization_request, db=mock_db)
...
class TestProgressiveLoadingErrorHandling:
    ...
    async def test_session_not_found_error(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            mock_service.get_progress.side_effect = Exception("Loading session not found")
    ...
    async def test_service_timeout_error(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            mock_service.start_loading.side_effect = asyncio.TimeoutError("Service timeout")
    ...
    async def test_insufficient_memory_error(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            mock_service.preload_adjacent.side_effect = MemoryError("Insufficient memory")
    ...
    async def test_network_connectivity_error(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            mock_service.optimize_settings.side_effect = ConnectionError("Network unreachable")
...
class TestProgressiveLoadingConcurrentOperations:
    ...
    async def test_concurrent_loading_sessions(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            ...
            tasks = [
                start_progressive_load(request, mock_db) 
    ...
    async def test_concurrent_progress_checks(self, mock_db):
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            ...
            tasks = [
                get_loading_progress(session_id, mock_db) 
...
class TestProgressiveLoadingPerformanceOptimization:
    ...
    async def test_adaptive_strategy_selection(self, mock_db):
        ...
        performance_scenarios = [
            {"network_speed": 10, "device_memory": 1024, "expected_strategy": "distance_based"},
            {"network_speed": 100, "device_memory": 4096, "expected_strategy": "viewport_based"},
            {"network_speed": 1000, "device_memory": 8192, "expected_strategy": "importance_based"}
        ]
        ...
        with patch('src.api.progressive.progressive_loading_service') as mock_service:
            for scenario in performance_scenarios:
                ...
                assert result["optimized_settings"]["strategy"] == scenario["expected_strategy"]
