...
class TestBatchAPI:
    ...
    async def test_submit_batch_job_service_error(self, client, mock_db, sample_job_data):
    ...
    async def test_upload_batch_data_service_error(self, client, mock_db, sample_batch_data):
        ...
        with patch('src.api.batch.get_db') as mock_get_db, \
            ...
            mock_results.return_value = {
                ...
                "results": [
                    ...
                    {"item_id": "item3", "status": "failed", "error": "Processing error"}
                ],
                "summary": {
                    "total_items": 3,
                    "successful_items": 2,
    ...
    async def test_get_batch_statistics_success(self, client, mock_db):
        ...
        with patch('src.api.batch.get_db') as mock_get_db, \
             patch.object(batch_processing_service, 'get_batch_statistics') as mock_stats:
    ...
    async def test_get_batch_statistics_with_date_range(self, client, mock_db):
        ...
        with patch('src.api.batch.get_db') as mock_get_db, \
            ...
            start_date = "2023-01-01T00:00:00Z"
            end_date = "2023-01-31T23:59:59Z"
            response = client.get(f"/statistics?start_date={start_date}&end_date={end_date}")
