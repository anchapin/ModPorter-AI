...
class TestStartQATask:
    ...
    def test_start_qa_task_with_user_config(self):
        ...
        conversion_id = str(uuid.uuid4())
        user_config = {"test_scenarios": ["basic", "stress"], "timeout": 300}
...
class TestGetQAStatus:
    ...
    def test_get_qa_status_completion_failure(self, mock_random):
        ...
        assert "results_summary" in result["task_info"]
        assert (
            result["task_info"]["results_summary"]["error_type"]
            == "Simulated critical failure during testing."
        )
...
class TestQAMainExample:
    ...
    def test_main_example_execution(self):
        ...
        start_response = start_qa_task(
            conv_id, user_config={"custom_param": "value123"}
        )
        ...
        if start_response["success"]:
            ...
            if task_id in mock_qa_tasks:
                ...
                mock_qa_tasks[task_id]["results_summary"] = {
...
class TestQAMainExecution:
    ...
    def test_main_block_coverage(self):
        ...
        import logging
        import uuid
        from src.api.qa import start_qa_task
...
class TestQAAPIEdgeCases:
    ...
    def test_task_id_collision_rare_case(self):
        ...
        assert (
            status1["task_info"]["conversion_id"]
            != status2["task_info"]["conversion_id"]
        )
