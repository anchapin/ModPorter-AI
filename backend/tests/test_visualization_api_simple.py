...
from src.api.visualization import (
    create_visualization, get_visualization, update_visualization_filters,
    change_visualization_layout, focus_on_node, create_filter_preset,
    get_filter_presets, get_filter_preset, export_visualization,
    get_visualization_metrics, get_visualization_types, get_layout_algorithms,
    get_filter_types, get_active_visualizations, delete_visualization,
    get_performance_stats, _get_layout_suitability
)
from src.services.advanced_visualization import (
    VisualizationType, FilterType, LayoutAlgorithm,
    VisualizationNode, VisualizationEdge, GraphCluster
)
...
class TestVisualizationCreation:
    ...
    async def test_create_visualization_success(self, mock_db, sample_viz_data):
        ...
        with patch('src.api.visualization.advanced_visualization_service') as mock_service:
            ...
            mock_service.create_visualization.assert_called_once_with(
                "test_graph_123", VisualizationType.FORCE_DIRECTED, 
                sample_viz_data["filters"], LayoutAlgorithm.SPRING, mock_db
            )
