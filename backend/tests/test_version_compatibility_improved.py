...
class TestVersionCompatibilityServiceImproved:
    ...
    async def test_get_compatibility_error(self, service, mock_db):
        ...
        with patch('src.services.version_compatibility.VersionCompatibilityCRUD') as mock_crud:
            mock_crud.get_compatibility = AsyncMock(side_effect=Exception("Database error"))
    ...
    async def test_get_by_java_version_error(self, service, mock_db):
        ...
        with patch('src.services.version_compatibility.VersionCompatibilityCRUD') as mock_crud:
            mock_crud.get_by_java_version = AsyncMock(side_effect=Exception("Database error"))
    ...
    async def test_get_relevant_patterns_error(self, service, mock_db):
        ...
        with patch('src.services.version_compatibility.ConversionPatternCRUD') as mock_crud:
            mock_crud.get_by_version = AsyncMock(side_effect=Exception("Database error"))
    ...
    def test_find_closest_version(self, service):
        ...
        versions = ["1.14.4", "1.15.2", "1.16.5", "1.17.1", "1.18.2", "1.19.4", "1.20.1"]
