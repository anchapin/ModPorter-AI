...
class TestVisualizationCreation:
    ...
    async def test_create_visualization_success(self, mock_db):
        ...
        with patch.object(
            advanced_visualization_service, "create_visualization"
        ) as mock_create:
    ...
    async def test_create_visualization_service_error(self, mock_db):
        ...
        with patch.object(
            ...
            mock_create.return_value = {"success": False, "error": "Graph not found"}
...
class TestVisualizationFilters:
    ...
    async def test_update_visualization_filters_success(self, mock_db):
        ...
        with patch.object(
            advanced_visualization_service, "update_visualization_filters"
        ) as mock_update:
            ...
            result = await router.update_visualization_filters(
                "viz_123", filter_data, mock_db
            )
    ...
    async def test_update_visualization_filters_service_error(self, mock_db):
        ...
        with patch.object(
            ...
            with pytest.raises(HTTPException) as exc_info:
                await router.update_visualization_filters(
                    "viz_123", filter_data, mock_db
                )
...
class TestVisualizationLayout:
    ...
    async def test_change_visualization_layout_success(self):
        ...
        with patch.object(
            advanced_visualization_service, "change_layout"
        ) as mock_change:
...
class TestVisualizationFocus:
    ...
    async def test_focus_on_node_success(self):
        ...
        with patch.object(
            advanced_visualization_service, "focus_on_node"
        ) as mock_focus:
...
class TestFilterPresets:
    ...
    async def test_create_filter_preset_success(self):
        ...
        with patch.object(
            advanced_visualization_service, "create_filter_preset"
        ) as mock_create:
            mock_create.return_value = {
                "success": True,
    ...
    async def test_create_filter_preset_missing_filters(self):
        ...
        preset_data = {"preset_name": "test_preset", "description": "Test preset"}
    ...
    async def test_get_filter_preset_success(self):
        ...
        advanced_visualization_service.filter_presets = {"java_classes": [mock_filter]}
...
class TestVisualizationExport:
    ...
    async def test_export_visualization_success(self):
        ...
        with patch.object(
            advanced_visualization_service, "export_visualization"
        ) as mock_export:
...
class TestVisualizationMetrics:
    ...
    async def test_get_visualization_metrics_success(self):
        ...
        with patch.object(
            advanced_visualization_service, "get_visualization_metrics"
        ) as mock_metrics:
...
class TestConcurrentOperations:
    ...
    async def test_concurrent_visualization_creation(self):
        ...
        with patch.object(
            ...
            tasks = [router.create_visualization(viz_data, mock_db) for _ in range(5)]
...
class TestVisualizationAPIIntegration:
    ...
    async def test_complete_visualization_workflow(self):
        ...
        with (
            ...
            filter_result = await router.update_visualization_filters(
                viz_id, filter_data, mock_db
            )
            ...
            layout_result = await router.change_visualization_layout(
                viz_id, layout_data
            )
...
class TestVisualizationAPIPerformance:
    ...
    async def test_performance_stats_with_large_visualization_cache(self):
        ...
        advanced_visualization_service.layout_cache = {
            f"viz_{i}": Mock() for i in range(25)
        }
        advanced_visualization_service.cluster_cache = {
            f"viz_{i}": Mock() for i in range(25)
        }
