...
@patch(
    "backend.src.api.behavior_templates.behavior_templates_crud.get_behavior_templates"
)
...
@patch(
    "backend.src.api.behavior_templates.behavior_templates_crud.get_behavior_template"
)
...
@patch(
    "backend.src.api.behavior_templates.behavior_templates_crud.create_behavior_template"
)
...
@patch(
    "backend.src.api.behavior_templates.behavior_templates_crud.update_behavior_template"
)
def test_update_behavior_template(
    mock_update_template, mock_get_template, mock_db_session
):
    template_id = uuid.uuid4()
...
@patch(
    "backend.src.api.behavior_templates.behavior_templates_crud.delete_behavior_template"
)
...
@patch(
    "backend.src.api.behavior_templates.behavior_templates_crud.apply_behavior_template"
)
@patch("backend.src.api.behavior_templates.crud.get_job")
@patch(
    "backend.src.api.behavior_templates.behavior_templates_crud.get_behavior_template"
)
def test_apply_behavior_template(
    mock_get_template, mock_get_job, mock_apply_template, mock_db_session
):
    template_id = uuid.uuid4()
    ...
    response = client.get(
        f"/templates/{template_id}/apply?conversion_id={conversion_id}"
    )
...
def test_apply_behavior_template_conversion_not_found(
    mock_get_template, mock_get_job, mock_db_session
):
    template_id = uuid.uuid4()
