...
class TestPeerReviewAPI:
    ...
    def sample_review_data(self):
        ...
        return {
            ...
            "content_analysis": {"score": 85, "comments": "Good work overall"},
    ...
    def test_get_contribution_reviews(self, client):
        ...
        response = client.get(
            f"/api/peer-review/reviews/contribution/{contribution_id}"
        )
    ...
    def test_get_contribution_reviews_with_status_filter(self, client):
        ...
        response = client.get(
            f"/api/peer-review/reviews/contribution/{contribution_id}?status=approved"
        )
    ...
    def test_get_reviewer_reviews_with_status_filter(self, client):
        ...
        response = client.get(
            f"/api/peer-review/reviews/reviewer/{reviewer_id}?status=completed"
        )
    ...
    def test_update_review_status(self, client):
        ...
        review_id = str(uuid.uuid4())
        update_data = {"status": "approved", "notes": "Review completed successfully"}

        response = client.put(
            f"/api/peer-review/reviews/{review_id}/status", json=update_data
        )
    ...
    def test_get_contribution_workflow(self, client):
        ...
        response = client.get(
            f"/api/peer-review/workflows/contribution/{contribution_id}"
        )
    ...
    def test_update_workflow_stage(self, client):
        ...
        response = client.put(
            f"/api/peer-review/workflows/{workflow_id}/stage", json=stage_update
        )
    ...
    def test_advance_workflow_stage(self, client):
        ...
        response = client.post(
            f"/api/peer-review/workflows/{workflow_id}/advance", json=advance_data
        )
    ...
    def test_add_reviewer_expertise_success(self, client, sample_expertise_data):
        ...
        response = client.post(
            "/api/peer-review/expertise/", json=sample_expertise_data
        )
    ...
    def test_create_or_update_reviewer_expertise(self, client):
        ...
        response = client.post(
            f"/api/peer-review/reviewers/expertise?reviewer_id={reviewer_id}",
            json=expertise_data,
        )
    ...
    def test_find_available_reviewers(self, client):
        ...
        response = client.get(
            "/api/peer-review/reviewers/available?expertise_area=java_modding&version=1.19.2&limit=5"
        )
    ...
    def test_update_reviewer_metrics(self, client):
        ...
        response = client.put(
            f"/api/peer-review/reviewers/{reviewer_id}/metrics", json=metrics
        )
    ...
    def test_get_daily_analytics(self, client):
        ...
        response = client.get(
            f"/api/peer-review/analytics/daily/{test_date.isoformat()}"
        )
    ...
    def test_update_daily_analytics(self, client):
        ...
        response = client.put(
            f"/api/peer-review/analytics/daily/{test_date.isoformat()}", json=metrics
        )
    ...
    def test_get_review_analytics_with_metrics_filter(self, client):
        ...
        response = client.get(
            "/api/peer-review/analytics/?metrics=volume,quality&time_period=7d"
        )
    ...
    def test_complete_review_workflow(
        self, client, sample_review_data, sample_workflow_data
    ):
        """Test complete review workflow from creation to completion."""
        # 1. Create workflow
        workflow_response = client.post(
            "/api/peer-review/workflows/", json=sample_workflow_data
        )
        ...
        review_response = client.post(
            "/api/peer-review/reviews/", json=sample_review_data
        )
        ...
        status_response = client.put(
            f"/api/peer-review/reviews/{review_id}/status", json=status_update
        )
    ...
    def test_reviewer_lifecycle(self, client, sample_expertise_data):
        ...
        get_expertise_response = client.get(
            f"/api/peer-review/reviewers/expertise/{reviewer_id}"
        )
        ...
        available_response = client.get(
            "/api/peer-review/reviewers/available?expertise_area=java_modding"
        )
        ...
        workload_response = client.get(
            f"/api/peer-review/reviewers/{reviewer_id}/workload"
        )
    ...
    def test_analytics_data_consistency(self, client):
        ...
        daily_response = client.get(
            f"/api/peer-review/analytics/daily/{today.isoformat()}"
        )
