...
class TestExperimentsAPI:
    ...
    def test_create_experiment_success(self, client, sample_experiment_data):
        ...
        assert data["traffic_allocation"] == sample_experiment_data["traffic_allocation"]
    ...
    def test_update_experiment_invalid_traffic_allocation(self, client):
        ...
        assert response.status_code == 400
        assert "Traffic allocation must be between 0 and 100" in response.json()["detail"]
    ...
    def test_create_experiment_variant_success(self, client, sample_variant_data):
        ...
        response = client.post(f"/api/experiments/{experiment_id}/variants", json=sample_variant_data)
    ...
    def test_create_experiment_variant_invalid_experiment_uuid(self, client):
        ...
        response = client.post(f"/api/experiments/{experiment_id}/variants", json=variant_data)
    ...
    def test_create_experiment_variant_default_is_control(self, client):
        ...
        data = response.json()
        assert data["is_control"] == False  # Should default to False
    ...
    def test_update_experiment_variant_success(self, client):
        ...
        response = client.put(f"/api/experiments/{experiment_id}/variants/{variant_id}", json=update_data)
    ...
    def test_delete_experiment_variant_success(self, client):
        ...
        response = client.delete(f"/api/experiments/{experiment_id}/variants/{variant_id}")
    ...
    def test_create_experiment_result_invalid_user_feedback_score_low(self, client):
        ...
        assert response.status_code == 400
        assert "user_feedback_score must be between 1 and 5" in response.json()["detail"]
    ...
    def test_experiment_lifecycle(self, client, sample_experiment_data, sample_variant_data):
        """Test complete experiment lifecycle from creation to completion."""
        # 1. Create experiment
        experiment_response = client.post("/api/experiments", json=sample_experiment_data)
        assert experiment_response.status_code == 200
        experiment_data = experiment_response.json()
        experiment_id = experiment_data["id"]
        
        # 2. Create variant
        variant_response = client.post(f"/api/experiments/{experiment_id}/variants", json=sample_variant_data)
        ...
        update_response = client.put(f"/api/experiments/{experiment_id}", json=status_update)
        ...
        results_response = client.get(f"/api/experiment_results?variant_id={variant_id}")
    ...
    def test_multiple_variants_same_experiment(self, client):
        ...
        control_response = client.post(f"/api/experiments/{experiment_id}/variants", json=control_data)
        ...
        test_response = client.post(f"/api/experiments/{experiment_id}/variants", json=test_data)
    ...
    def test_variant_with_complex_strategy_config(self, client):
        ...
        response = client.post(f"/api/experiments/{experiment_id}/variants", json=complex_config)
        assert response.status_code == 200
        
        data = response.json()
        assert "strategy_config" in data
        assert data["strategy_config"]["ui_changes"]["button_color"] == "#FF5722"
        assert data["strategy_config"]["feature_flags"]["new_checkout"] == True
    ...
    def test_experiment_deletion_cascade_behavior(self, client):
        ...
        variant_data = {"name": "Test Variant"}
        variant_response = client.post(f"/api/experiments/{experiment_id}/variants", json=variant_data)
        assert variant_response.status_code == 200
        ...
        assert get_experiment_response.status_code in [404, 500]  # Depends on implementation
