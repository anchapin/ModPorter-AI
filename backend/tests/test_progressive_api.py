...
class TestProgressiveAPI:
    ...
    async def test_start_progressive_load_success(
        self, client, mock_db, sample_load_data
    ):
        """Test successful progressive load start."""
        with (
            patch("src.api.progressive.get_db") as mock_get_db,
            patch.object(
                progressive_loading_service, "start_progressive_load"
            ) as mock_load,
        ):
    ...
    def test_start_progressive_load_invalid_detail_level(self, client, mock_db):
        ...
        with patch("src.api.progressive.get_db") as mock_get_db:
            ...
            load_data = {"visualization_id": "viz123", "detail_level": "invalid_level"}
    ...
    def test_start_progressive_load_invalid_priority(self, client, mock_db):
        ...
        with patch("src.api.progressive.get_db") as mock_get_db:
            ...
            load_data = {"visualization_id": "viz123", "priority": "invalid_priority"}
    ...
    def test_start_progressive_load_service_error(
        self, client, mock_db, sample_load_data
    ):
        ...
        with (
            ...
            mock_get_db.return_value = mock_db
            mock_load.return_value = {"success": False, "error": "Service unavailable"}
    ...
    async def test_get_load_task_status_success(self, client):
        ...
        with patch.object(
            progressive_loading_service, "get_task_status"
        ) as mock_status:
    ...
    async def test_get_load_task_status_not_found(self, client):
        ...
        with patch.object(
            ...
            mock_status.return_value = {"success": False, "error": "Task not found"}
    ...
    def test_update_loading_level_success(self, client):
        ...
        with patch.object(
            progressive_loading_service, "update_loading_level"
        ) as mock_update:
            ...
            response = client.post(
                "/progressive/tasks/task123/update-level", json=update_data
            )
    ...
    def test_get_loading_statistics_success(self, client):
        ...
        with patch.object(
            progressive_loading_service, "get_loading_statistics"
        ) as mock_stats:
    ...
    def test_get_loading_statistics_with_filters(self, client):
        ...
        with patch.object(
            ...
            end_date = "2023-01-31T23:59:59Z"
            response = client.get(
                f"/progressive/statistics?start_date={start_date}&end_date={end_date}"
            )
    ...
    def test_estimate_load_time_success(self, client, mock_db):
        ...
        with (
            patch("src.api.progressive.get_db") as mock_get_db,
            patch.object(
                progressive_loading_service, "estimate_load_time"
            ) as mock_estimate,
        ):
            mock_get_db.return_value = mock_db
    ...
    def test_optimize_settings_success(self, client, mock_db):
        ...
        with (
            patch("src.api.progressive.get_db") as mock_get_db,
            patch.object(
                progressive_loading_service, "optimize_settings"
            ) as mock_optimize,
        ):
            mock_get_db.return_value = mock_db
            ...
            optimize_data = {
                ...
                "user_preferences": {"prioritize_speed": True, "max_memory": "200MB"},
            }
    ...
    def test_get_health_status_success(self, client):
        ...
        with patch.object(
            progressive_loading_service, "get_health_status"
        ) as mock_health:
...
class TestProgressiveAPIEdgeCases:
    ...
    def test_unicode_data_in_progressive_load(self, client, mock_db):
        ...
        with (
            ...
            load_data = {
                ...
                "parameters": {"title": "テスト可視化", "description": "可视化测试"},
            }
    ...
    def test_invalid_date_range_in_statistics(self, client):
        ...
        with patch.object(
            ...
            response = client.get(
                "/progressive/statistics?start_date=2023-01-31&end_date=2023-01-01"
            )
