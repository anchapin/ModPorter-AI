...
class TestValidationAPI:
    ...
    def test_start_validation_job_minimal_request(self, client):
        ...
        request_data = {
            "conversion_id": "minimal_test_123"
        }
    ...
    def test_get_validation_report_job_not_completed(self, client, sample_validation_request):
    ...
    def test_validation_job_status_transitions(self, client, sample_validation_request):
