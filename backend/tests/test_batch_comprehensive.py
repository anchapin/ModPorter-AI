...
from src.api.batch import router, submit_batch_job, get_job_status, cancel_job, pause_job, resume_job
from src.api.batch import get_active_jobs, get_job_history, import_nodes, import_relationships
from src.api.batch import export_graph, batch_delete_nodes, batch_validate_graph, get_operation_types
from src.api.batch import get_processing_modes, get_status_summary, get_performance_stats
...
class TestBatchErrorHandling:
    ...
    async def test_database_error_handling(self, mock_service):
        ...
        mock_service.get_job_status.side_effect = Exception("Database connection failed")
