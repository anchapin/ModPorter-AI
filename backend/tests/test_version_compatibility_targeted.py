...
class TestVersionCompatibilityTargeted:
    ...
    async def test_get_by_java_version_with_results(self, service, mock_db):
        ...
        with patch(
            "src.services.version_compatibility.VersionCompatibilityCRUD.get_by_java_version"
        ) as mock_get_by_java:
    ...
    async def test_update_compatibility_existing_entry(self, service, mock_db):
        ...
        with (
            ...
            patch(
                "src.services.version_compatibility.db.knowledge_graph_crud.VersionCompatibilityCRUD.update"
            ) as mock_update,
        ):
    ...
    async def test_update_compatibility_new_entry(self, service, mock_db):
        ...
        with (
            ...
            patch(
                "src.services.version_compatibility.VersionCompatibilityCRUD.create"
            ) as mock_create,
        ):
    ...
    async def test_update_compatibility_error_handling(self, service, mock_db):
        ...
        with patch(
            ...
            result = await service.update_compatibility("1.19.0", "1.18.0", {}, mock_db)
    ...
    async def test_get_conversion_path_with_result(self, service, mock_db):
        ...
        with patch(
            ...
            result = await service.get_conversion_path(
    ...
    async def test_get_matrix_overview_with_data(self, service, mock_db):
        ...
        mock_entries = [
            Mock(
                java_version="1.19.0", bedrock_version="1.18.0", compatibility_score=0.9
            ),
            Mock(
                java_version="1.19.0", bedrock_version="1.17.0", compatibility_score=0.7
            ),
            Mock(
                java_version="1.18.0", bedrock_version="1.17.0", compatibility_score=0.8
            ),
            Mock(
                java_version="1.20.0",
        ...
        with patch(
            "src.services.version_compatibility.db.knowledge_graph_crud.VersionCompatibilityCRUD.get_all"
        ) as mock_get_all:
    ...
    async def test_generate_migration_guide_with_data(self, service, mock_db):
        ...
        with (
            ...
            assert any(
                step["action"] == "extract_entity_data" for step in result["steps"]
            )
    ...
    async def test_find_optimal_conversion_path_with_data(self, service):
        ...
        mock_entries = [
            ...
            Mock(
                java_version="1.19.0", bedrock_version="1.17.0", compatibility_score=0.6
            ),
            Mock(
                java_version="1.18.0", bedrock_version="1.17.0", compatibility_score=0.8
            ),
    ...
    def test_generate_direct_migration_steps_with_data(self, service):
        ...
        result = service._generate_direct_migration_steps(
            mock_compatibility, "entities", [], mock_db
        )
    ...
    def test_generate_gradual_migration_steps_with_path(self, service):
        ...
        result = service._generate_gradual_migration_steps(
            path, "entities", [], mock_db
        )
