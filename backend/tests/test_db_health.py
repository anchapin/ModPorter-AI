...
class TestHealthCheckResult:
    ...
    def test_health_check_result_creation(self):
        ...
        result = HealthCheckResult(is_healthy=True, message="Database is healthy", latency_ms=5.5)
...
class TestQueryMetrics:
    ...
    def test_query_metrics_creation(self):
        ...
        metrics = QueryMetrics(
            query_text="SELECT * FROM users", execution_time_ms=15.5, rows_affected=10
        )
    ...
    def test_query_metrics_with_error(self):
        ...
        metrics = QueryMetrics(
            query_text="SELECT * FROM invalid_table", execution_time_ms=5.0, error="Table not found"
        )
...
class TestConnectionPoolMetrics:
    ...
    def test_pool_metrics_creation(self):
        ...
        metrics = ConnectionPoolMetrics(pool_size=10, checked_in=8, checked_out=2, overflow=0)
    ...
    def test_pool_metrics_to_dict(self):
        ...
        metrics = ConnectionPoolMetrics(pool_size=5, checked_in=3, checked_out=2)
...
class TestDatabaseHealthChecker:
    ...
    def test_record_query(self, health_checker):
        ...
        metrics = QueryMetrics(query_text="SELECT * FROM test", execution_time_ms=50.0)
