...
class TestPeerReviewCRUD:
    ...
    async def test_create_success(
        self, mock_db, sample_review_data, sample_review_model
    ):
        ...
        with patch(
            "src.db.peer_review_crud.PeerReviewModel", return_value=sample_review_model
        ):
    ...
    async def test_get_by_reviewer_success(self, mock_db):
        ...
        result = await PeerReviewCRUD.get_by_reviewer(
            mock_db, "reviewer_001", "pending"
        )
    ...
    async def test_update_status_success(self, mock_db):
        ...
        result = await PeerReviewCRUD.update_status(
            mock_db, "review_001", "approved", {"score": 85, "feedback": "Good work"}
        )
    ...
    async def test_update_status_failure(self, mock_db):
        ...
        result = await PeerReviewCRUD.update_status(
            mock_db, "review_001", "approved", {"score": 85}
        )
...
class TestReviewWorkflowCRUD:
    ...
    async def test_create_workflow_success(
        self, mock_db, sample_workflow_data, sample_workflow_model
    ):
        ...
        with patch(
            "src.db.peer_review_crud.ReviewWorkflowModel",
    ...
    async def test_update_workflow_stage_success(self, mock_db):
        ...
        result = await ReviewWorkflowCRUD.update_stage(
            mock_db, "workflow_001", "final_review", {"status": "completed"}
        )
...
class TestReviewerExpertiseCRUD:
    ...
    @pytest.mark.asyncio
    async def test_create_expertise_success(
        self, mock_db, sample_expertise_data, sample_expertise_model
    ):
        ...
        with patch(
            "src.db.peer_review_crud.ReviewerExpertiseModel",
            return_value=sample_expertise_model,
        ):
    ...
    async def test_update_expertise_level_success(self, mock_db):
        ...
        result = await ReviewerExpertiseCRUD.update_expertise_level(
            mock_db, "expertise_001", 9, {"verified_reviews": 30, "average_rating": 4.7}
        )
    ...
    async def test_get_top_reviewers_by_domain_success(self, mock_db):
        ...
        result = await ReviewerExpertiseCRUD.get_top_reviewers_by_domain(
            mock_db, "java_modding", 10
        )
...
class TestReviewTemplateCRUD:
    ...
    async def test_create_template_success(
        self, mock_db, sample_template_data, sample_template_model
    ):
        ...
        with patch(
            "src.db.peer_review_crud.ReviewTemplateModel",
    ...
    async def test_update_template_success(self, mock_db):
        ...
        result = await ReviewTemplateCRUD.update_template(
            mock_db, "template_001", {"name": "Updated Template", "is_active": False}
        )
...
class TestReviewAnalyticsCRUD:
    ...
    @pytest.mark.asyncio
    async def test_create_analytics_success(
        self, mock_db, sample_analytics_data, sample_analytics_model
    ):
        ...
        with patch(
            "src.db.peer_review_crud.ReviewAnalyticsModel",
            return_value=sample_analytics_model,
        ):
    ...
    async def test_get_or_create_daily_success(self, mock_db, sample_analytics_model):
        ...
        try:
            await ReviewAnalyticsCRUD.get_or_create_daily(mock_db, date(2023, 11, 11))
    ...
    async def test_get_analytics_by_date_range_success(self, mock_db):
        ...
        result = await ReviewAnalyticsCRUD.get_by_date_range(
            mock_db, start_date, end_date
        )
    ...
    async def test_get_reviewer_performance_metrics_success(self, mock_db):
        ...
        result = await ReviewAnalyticsCRUD.get_reviewer_performance_metrics(
            mock_db, "reviewer_001"
        )
