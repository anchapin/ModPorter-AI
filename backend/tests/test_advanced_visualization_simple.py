...
class TestVisualizationDataclasses:
    ...
    def test_visualization_state_dataclass(self):
        ...
        state_obj = VisualizationState(
            ...
            nodes=[
                VisualizationNode(
                    id="node_1", label="Node 1", type="test", platform="java"
                )
            ],
            edges=[
                VisualizationEdge(
                    id="edge_1", source="node_1", target="node_2", type="test"
                )
            ],
            clusters=[GraphCluster(cluster_id=1, name="Cluster 1")],
            filters=[
                VisualizationFilter(
                    filter_id="filter_1",
                    filter_type=FilterType.NODE_TYPE,
...
class TestVisualizationDataclassDefaults:
    ...
    def test_visualization_node_defaults(self):
        ...
        node_obj = VisualizationNode(
            id="node_123", label="Test Node", type="conversion", platform="java"
        )
    ...
    def test_visualization_edge_defaults(self):
        ...
        edge_obj = VisualizationEdge(
            id="edge_123", source="node_1", target="node_2", type="transforms_to"
        )
...
class TestVisualizationSerialization:
    ...
    def test_complex_state_serialization(self):
        ...
        complex_state = VisualizationState(
            ...
            nodes=[
                VisualizationNode(
                    id="n1", label="Node 1", type="type1", platform="java"
                ),
                VisualizationNode(
                    id="n2", label="Node 2", type="type2", platform="bedrock"
                ),
            ],
            edges=[
                VisualizationEdge(id="e1", source="n1", target="n2", type="transforms")
            ],
            clusters=[GraphCluster(cluster_id=1, name="Cluster 1", nodes=["n1", "n2"])],
            filters=[
                VisualizationFilter(
                    filter_id="f1",
                    filter_type=FilterType.NODE_TYPE,
...
class TestVisualizationPerformanceMetrics:
    ...
    def test_metrics_calculation(self):
        ...
        nodes = [
            ...
            VisualizationNode(
                id="n3", label="Node 3", type="type2", platform="bedrock"
            ),
        ]
