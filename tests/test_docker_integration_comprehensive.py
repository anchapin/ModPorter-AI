...
def mock_container():
    ...
    container.name = "modporter_backend"
...
def mock_network():
    ...
    network = MagicMock()
    network.name = "modporter_network"
    network.containers = {}
    return network
...
class TestDockerComposeLaunch:
    ...
    async def test_compose_network_creation(self, mock_docker_client):
        ...
        result = {
            "network_created": "modporter_network",
            "driver": "bridge"
        }
        
        assert result["network_created"] == "modporter_network"
    ...
    async def test_compose_volume_mounting(self, mock_docker_client):
        ...
        volumes = {
            "/data/conversions": "/app/conversions",
...
class TestEnvVariables:
    ...
    async def test_env_variable_passing(self, mock_docker_client):
        ...
        env_vars = {
            ...
            "DATABASE_URL": "postgresql://db:5432/modporter",
    ...
    async def test_secret_management(self, mock_docker_client):
        ...
        secrets = {
            "db_password": "should_not_be_logged",
            "api_key": "secret_xyz"
        }
