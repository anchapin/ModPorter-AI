...
class TestAuthenticationBasics:
    ...
    async def test_expired_token_rejection(self, mock_auth_service):
        ...
        mock_auth_service.verify_token = AsyncMock(side_effect=ValueError("Token expired"))
    ...
    async def test_missing_token_rejection(self, mock_auth_service):
        ...
        mock_auth_service.verify_token = AsyncMock(side_effect=ValueError("Token required"))
...
class TestInputValidation:
    ...
    def test_xss_prevention(self):
        ...
        safe_input = malicious_input.replace("<", "&lt;").replace(">", "&gt;")
...
class TestCORSSecurity:
    ...
    def test_cors_preflight_request(self):
        ...
        is_preflight = (
            ...
            and "Access-Control-Request-Method" in preflight["headers"]
        )
