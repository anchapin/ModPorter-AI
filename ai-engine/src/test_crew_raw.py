#!/usr/bin/env python3
"""
Test CrewAI with raw ChatOllama instance (no wrapper)
"""
...
def test_crew_raw_ollama():
    """Test CrewAI with raw ChatOllama instance"""
    try:
        ...
        print(f"Direct LLM test: {result}")
