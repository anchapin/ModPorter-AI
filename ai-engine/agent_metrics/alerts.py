...
class Alert:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "acknowledged_at": datetime.fromtimestamp(self.acknowledged_at).isoformat()
...
class AlertManager:
    ...
    def create_alert(
        self, alert_type: str, severity: AlertSeverity, message: str, data: Dict[str, Any] = None
    ) -> Optional[Alert]:
        """
        Create a new alert.
    ...
    def alert_cost_threshold(self, total_cost: float, threshold: float = None):
        ...
        return self.create_alert(
            ...
            data={"total_cost": total_cost, "threshold": threshold},
        )
    ...
    def alert_error_rate(self, error_rate: float, operation: str = None):
        ...
        return self.create_alert(
            ...
            data={"error_rate": error_rate, "threshold": threshold, "operation": operation},
        )
    ...
    def alert_llm_failure(self, model: str, error: str, provider: str = None):
        ...
        return self.create_alert(
            ...
            data={"model": model, "provider": provider, "error": error},
        )

    def alert_custom(
        self, alert_type: str, severity: AlertSeverity, message: str, data: Dict = None
    ):
    ...
    def get_alert_summary(self) -> Dict:
        ...
        total = len(alerts)
        if total == 0:
            return {"total_alerts": 0, "by_severity": {}, "by_type": {}, "unacknowledged": 0}
    ...
    def _check_rate_limit(self, alert_type: str) -> bool:
        ...
        self._alert_counts[alert_type] = [
            t for t in self._alert_counts[alert_type] if current_time - t < self._rate_limit_window
        ]
