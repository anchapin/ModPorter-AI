...
class TestPerformanceMetrics:
    ...
    def test_performance_metrics_to_dict(self):
        ...
        metrics = PerformanceMetrics(
            execution_time_ms=500, memory_usage_mb=64.0, cpu_usage_percent=30.0
        )
...
class TestMinecraftBedrockValidator:
    ...
    def test_validator_initialization(self):
        ...
        config = {"test_world_path": "./custom_worlds", "bedrock_server_path": "./custom_bedrock"}
    ...
    async def test_validate_addon_behavior(self):
        ...
        test_scenarios = [
            {"name": "Block Placement Test", "expected_behavior": {"block_placed": True}},
            {"name": "Entity Spawn Test", "expected_behavior": {"entity_spawned": True}},
        ]
...
class TestRegressionTestManager:
    ...
    def test_manager_initialization(self):
        ...
        config = {"test_suite_path": "./custom_tests", "known_good_path": "./custom_known_good"}
    ...
    def test_run_regression_tests(self, mock_random):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            conversion_tests = {
                "test_cases": [
                    {"name": "basic_block_conversion", "type": "conversion", "priority": "HIGH"},
                    {"name": "entity_conversion", "type": "conversion", "priority": "MEDIUM"},
                ]
            }
...
class TestComprehensiveTestingFramework:
    ...
    async def test_run_comprehensive_test_suite(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            config = {"test_data_path": temp_dir, "results_path": temp_dir}
