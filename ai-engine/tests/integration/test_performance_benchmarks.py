...
class PerformanceBenchmarks(unittest.TestCase):
    ...
    def test_single_block_performance(self):
        ...
        for mod_id, blocks in mod_configs:
            ...
            self.results.append(
                {"test": "single_block", "mod_id": mod_id, "block_count": len(blocks), **perf_data}
            )
    ...
    def test_multi_block_scaling(self):
        ...
        for count in block_counts:
            ...
            # Performance assertions - adjusted for CI environment
            self.assertLess(
                perf_data["avg_time"], count * 75.0, "Should scale better than 75.0s per block"
            )
    ...
    def test_mod_framework_comparison(self):
        ...
        frameworks = [
            (
                "fabric",
                lambda m, p: self.generator.create_mod_jar(
                    m, blocks=["test_block"], items=["test_item"]
                ),
            ),
    ...
    def test_file_size_impact(self):
        ...
        for complexity in complexity_levels:
            ...
            if complexity == "simple":
                jar_path = self.generator.create_mod_jar(
                    mod_id,
                ...
                jar_path = self.generator.create_mod_jar(
                    mod_id,
                    blocks=[f"block_{i}" for i in range(50)],
    ...
    def test_concurrent_conversions(self):
        ...
        for i in range(mod_count):
            ...
            jar_path = self.generator.create_mod_jar(
                mod_id, blocks=[f"block_{i}"], items=[f"item_{i}"]
            )
