...
SAMPLE_MANIFEST_DATA = {
    "files": [
        ...
        {"projectID": 3, "fileID": 300, "name": "ModC", "version": "1.5.0", "dependencies": []},
    ]
}
        ...
        for i, mod_id in enumerate(order):
            ...
            if mod:
                for dep in mod.dependencies:
                    ...
                    assert dep_idx < i or dep_idx == -1, (
                        f"Dependency {dep.mod_id} should come before {mod_id}"
                    )
...
class TestDependencyAnalysisResult:
    ...
    def test_default_values(self):
        ...
        result = DependencyAnalysisResult(graph=DependencyGraph(), success=True)
