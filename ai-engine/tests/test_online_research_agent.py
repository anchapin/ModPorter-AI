...
class TestOnlineResearchAgent:
    ...
    def test_validate_addon(self):
        ...
        result = agent.validate_addon("test_conversion", "/fake/addon/path", checklist)
    ...
    def test_export_research_report(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            research_data = {"conversion_id": "test", "sources": [], "all_features": ["feature1"]}
...
class TestOnlineResearchAgentIntegration:
    ...
    def test_research_and_validate_workflow(self):
        ...
        # Research
        research_data = agent.research_mod(["https://modrinth.com/mod/test"], "test_conv")

        # Generate checklist
        checklist = agent.generate_checklist(research_data, SourceType.MODRINTH)

        # Validate
        report = agent.validate_addon("test_conv", "/fake/path", checklist)
...
class TestOnlineResearchAgentEdgeCases:
    ...
    def test_validate_empty_checklist(self):
        ...
        report = agent.validate_addon("test", "/fake/path", [])
