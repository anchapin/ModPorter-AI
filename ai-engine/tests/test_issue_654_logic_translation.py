...
class TestRecipeConversion:
    ...
    def test_convert_shaped_recipe(self, agent):
        ...
        assert recipe['minecraft:recipe_shaped']['description']['identifier'] == 'mod:copper_sword_recipe'
...
class TestIntegration:
    ...
    def test_full_mod_conversion_flow(self, agent):
        ...
        # Convert items
        items = [
            {'name': 'CopperIngot', 'registry_name': 'mod:copper_ingot', 'properties': {'item_type': 'basic'}},
            {'name': 'CopperSword', 'registry_name': 'mod:copper_sword', 'properties': {'item_type': 'sword', 'max_durability': 200}},
        ]
        ...
        # Convert entity
        entity = {'name': 'CopperGolem', 'registry_name': 'mod:copper_golem', 'properties': {'entity_type': 'hostile'}}
