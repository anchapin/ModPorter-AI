...
class TestTemplateEngine:
    ...
    def test_render_basic_block(self, template_engine):
        ...
        result = template_engine.render_template(
            feature_type="block", properties={}, context=context, pack_type="bp"
        )
    ...
    def test_render_item(self, template_engine):
        ...
        context = {"namespace": "modpack", "item_name": "copper_sword"}

        result = template_engine.render_template(
            feature_type="item", properties={"tool": True}, context=context
        )
    ...
    def test_render_recipe(self, template_engine):
        ...
        result = template_engine.render_template(
            feature_type="recipe", properties={}, context=context
        )
...
class TestTemplateCategories:
    ...
    def test_item_categories(self):
        ...
        for it in item_types:
            assert it.value.endswith("_item") or it in [
                TemplateType.TOOL,
                TemplateType.WEAPON,
                TemplateType.ARMOR,
                TemplateType.CONSUMABLE,
