...
class TestValidationModels:
    ...
    def test_validation_models_exist(self):
        ...
        if importlib.util.find_spec("models.validation") is None:
    ...
    def test_validation_result_base(self):
        ...
        result = {"valid": True, "errors": [], "warnings": ["test warning"]}
    ...
    def test_semantic_analysis_structure(self):
        ...
        result = {"confidence": 0.85, "intent_preserved": True, "findings": ["test finding"]}
    ...
    def test_behavior_prediction_structure(self):
        ...
        result = {"predicted_behavior": "spawns_entity", "confidence": 0.9, "discrepancies": []}
    ...
    def test_asset_validation_structure(self):
        ...
        result = {"asset_path": "/textures/item.png", "valid": True, "missing_alternatives": []}
...
class TestValidationAgentAdvanced:
    ...
    def test_validation_performance(self):
        ...
        start = time.time()
        analyzer.analyze("function test() { return true; }")
