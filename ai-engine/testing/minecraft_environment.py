...
class MinecraftEnvironmentManager:
    def __init__(self, server_ip: str = "localhost", server_port: int = 19132):
        ...
        self.logger.info(
            f"MinecraftEnvironmentManager initialized for server at {self.server_ip}:{self.server_port}"
        )
    ...
    def start_server(self):
        ...
        self.logger.info(
            f"Attempting to start Minecraft Bedrock server at {self.server_ip}:{self.server_port}..."
        )
