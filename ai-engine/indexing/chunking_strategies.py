...
class RecursiveChunking(BaseChunkingStrategy):
    ...
    def chunk(self, text: str, chunk_size: int = 512, overlap: int = 50, 
              separators: Optional[List[str]] = None, **kwargs) -> List[Chunk]:
        """
    ...
    def _recursive_split(self, text: str, separators: List[str], 
                        max_size: int, heading_context: List[str]) -> List[Chunk]:
