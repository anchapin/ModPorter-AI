"""
Distributed Tracing Service using OpenTelemetry for AI Engine.

This module provides tracing capabilities for the AI Engine service,
...
def get_tracer(service_name: str = "modporter-ai-engine") -> trace.Tracer:
    """
...
def init_tracing(
    app=None,
    service_name: str = "modporter-ai-engine",
