...
def test_one_click_conversion():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('one_click_converter', 'ai-engine/services/one_click_converter.py')
        ...
        print(f"Settings: detail={result.settings.detail_level}, optimization={result.settings.optimization}")
