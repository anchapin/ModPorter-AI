...
def test_model_caching():
    ...
    try:
        from services.model_cache import get_model_cache, get_llm_cache
...
def test_circuit_breaker():
    ...
    try:
        from utils.error_recovery import CircuitBreaker, CircuitBreakerOpen, CircuitState
