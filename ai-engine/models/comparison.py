...
class ComparisonResult:
    ...
    assumptions_applied: List[Dict[str, Any]] = field(
        default_factory=list
    )  # List of assumptions and their context
    confidence_scores: Dict[str, float] = field(
        default_factory=dict
    )  # Overall or per-category scores
...
if __name__ == "__main__":
    ...
    cr = ComparisonResult(
        ...
        structural_diff={
            "files_added": ["bp/blocks/custom.json"],
            "files_removed": ["java/com/example/MyBlock.java"],
        },
        ...
        assumptions_applied=[
            {
                "assumption": "GUI_TO_SIGN_INTERFACE",
                "details": "Converted Java GUI to Bedrock sign.",
            }
        ],
