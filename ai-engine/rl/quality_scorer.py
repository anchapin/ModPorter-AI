...
class ConversionQualityScorer:
    ...
    def assess_conversion_quality(
        ...
        """
        logger.info(
            f"Starting quality assessment for conversion: {original_mod_path} -> {converted_addon_path}"
        )
                ...
                with zipfile.ZipFile(mod_path, "r") as jar:
                    ...
                    for file_path in file_list:
                        if "blocks" in file_path.lower() or "block" in file_path.lower():
                            ...
                            ext in file_path.lower() for ext in [".png", ".jpg", ".json", ".mcmeta"]
                        ):
    ...
    def _calculate_completeness_score(
        self, original: Dict[str, Any], converted: Dict[str, Any], metrics: QualityMetrics
    ) -> float:
    ...
    def _calculate_correctness_score(
        self, converted: Dict[str, Any], metrics: QualityMetrics
    ) -> float:
    ...
    def _calculate_performance_score(
        self, converted: Dict[str, Any], metadata: Dict[str, Any], metrics: QualityMetrics
    ) -> float:
