...
- AI Engine (FastAPI+LangChain/LangGraph): 8001
- PostgreSQL: 5433
- Redis: 6379
...
- Conversion pipeline: ai-engine/orchestration/langgraph_pipeline.py
...
### Do Not Touch
- ai-engine/search/rag_pipeline.py (RAG — tied to LangChain tool interfaces)
