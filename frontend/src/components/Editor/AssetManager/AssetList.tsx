...
export const AssetList: React.FC = () => {
  ...
  const handleReplaceAsset = (assetId: string) => {
    ...
    console.log(
      `Replace asset clicked for: ${assetId}. (Functionality not fully implemented)`
    );
  ...
  if (!addonData || !addonData.assets || addonData.assets.length === 0) {
    return (
      <div className="asset-list-status">No assets found in this addon.</div>
    );
  }
        ...
        {addonData.assets.map((asset) => (
          <li key={asset.id} className="asset-item">
            <div className="asset-preview">
              ...
              (asset.path.endsWith('.png') || asset.path.endsWith('.jpg')) ? (
                ...
                <img
                  src={`${API_BASE_URL}/addons/${addonData.id}/assets/${asset.id}`}
            ...
            <div className="asset-actions">
              ...
              <button
                onClick={() => handleDeleteAsset(addonData.id, asset.id)}
