...
export const PropertiesPanel: React.FC = () => {
  const { addonData, selectedBlockId, updateBlockProperty } =
    useEditorContext();
  ...
  const [behaviorDataJsonString, setBehaviorDataJsonString] =
    useState<string>('');
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (selectedBlock?.behavior?.data) {
        setBehaviorDataJsonString(
          JSON.stringify(selectedBlock.behavior.data, null, 2)
        );
  ...
  if (!selectedBlock) {
    return (
      <div className="properties-panel-empty">
        Selected block not found (this may be a brief state during updates).
      </div>
    );
  }
    ...
    <div className="properties-panel-container">
      ...
      <div className="properties-grid">
        <div className="property-item">
          <label htmlFor="blockId" className="property-label">
            ID:
          </label>
          <input
            id="blockId"
        ...
        <div className="property-item">
          <label htmlFor="blockIdentifier" className="property-label">
            Identifier:
          </label>
          <input
            id="blockIdentifier"
        ...
        <div className="property-section">
          ...
          />
          {propertiesError && (
            <small className="json-error-message">{propertiesError}</small>
          )}
        </div>
        ...
        <div className="property-section">
          ...
          {selectedBlock.behavior ? (
            <>
              <div className="property-item">
                <label htmlFor="behaviorId" className="property-label">
                  Behavior ID:
                </label>
                <input
                  id="behaviorId"
                  type="text"
                  className="property-value"
                  value={selectedBlock.behavior.id}
                  readOnly
                />
              </div>
              ...
              <div className="property-item">
                <label htmlFor="isExplosive" className="property-label">
                  Is Explosive (custom):
                </label>
                <input
                  id="isExplosive"
                  ...
                  checked={
                    getPropertyByPath(
                      selectedBlock,
                      'behavior.data.custom:is_explosive'
                    ) === true
                  }
                  onChange={(e) =>
                    handleInputChange(
              ...
              <div className="property-item">
                <label htmlFor="destroyOnUse" className="property-label">
                  Destroy on Use (custom):
                </label>
                <input
                  id="destroyOnUse"
                  type="checkbox"
                  ...
                  checked={
                    getPropertyByPath(
                      selectedBlock,
                      'behavior.data.custom:destroy_on_use'
                    ) === true
                  }
                  onChange={(e) =>
                    handleInputChange(
              ...
              <label
                htmlFor="behaviorDataJson"
                className="property-label-fullwidth"
              >
                Raw Behavior Data (JSON):
              </label>
              <textarea
                id="behaviorDataJson"
              ...
              />
              {behaviorError && (
                <small className="json-error-message">{behaviorError}</small>
              )}
            </>
          ) : (
            <div className="property-item">
