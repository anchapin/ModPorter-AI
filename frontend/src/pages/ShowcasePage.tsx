...
const successStories = [
  {
    ...
    screenshot:
      'https://placehold.co/600x400/1e293b/6366f1?text=RPG+Prodigy+Screenshot',
  ...
  },
  {
    ...
    screenshot:
      'https://placehold.co/600x400/1e293b/10b981?text=TechCore+Machinery',
  ...
  },
  {
    ...
    screenshot:
      'https://placehold.co/600x400/1e293b/a855f7?text=Ender+Expansion',
...
const galleryImages = [
  {
    src: 'https://placehold.co/400x300/1e293b/6366f1?text=Converted+Mod+1',
    alt: 'Converted mod screenshot 1',
  },
  {
    src: 'https://placehold.co/400x300/1e293b/10b981?text=Converted+Mod+2',
    alt: 'Converted mod screenshot 2',
  },
  {
    src: 'https://placehold.co/400x300/1e293b/f59e0b?text=Converted+Mod+3',
    alt: 'Converted mod screenshot 3',
  },
  {
    src: 'https://placehold.co/400x300/1e293b/ec4899?text=Converted+Mod+4',
    alt: 'Converted mod screenshot 4',
  },
  {
    src: 'https://placehold.co/400x300/1e293b/06b6d4?text=Converted+Mod+5',
    alt: 'Converted mod screenshot 5',
  },
  {
    src: 'https://placehold.co/400x300/1e293b/8b5cf6?text=Converted+Mod+6',
    alt: 'Converted mod screenshot 6',
  },
];
    ...
    <div className="showcase-page">
      <section className="hero-section">
        <div className="section-container">
          ...
          <h1 className="hero-title">Real Mods, Real Success</h1>
          <p className="hero-subtitle">
            See how developers are bringing their Java mods to the Bedrock
            Marketplace with Portkit
          </p>
        </div>
      </section>
      ...
      <section className="testimonials-section">
        <div className="section-container">
          ...
          <p className="section-subtitle">Hear from the community</p>
        ...
        <div className="section-container">
          <div className="discord-card">
            ...
            <p className="discord-description">
              Share your conversion results, get help, and connect with other
              mod developers in our Discord server.
            </p>
            <a
